...
<?php
    ...
    if(isset($_SESSION["trueModificacion"])&&($_SESSION["trueModificacion"]==true)){
        ...
        Modificado correctamente en la BD
    </div>";
    ...
    if(isset($_SESSION["trueDelete"])&&($_SESSION["trueDelete"]==true)){
        ...
        Borrado correctamente en la BD
    </div>";
...
<?php if(isset($_SESSION['idProfesor'])) $_SESSION['idProfesor']=$_POST['id2Profesor'];?>
            <input class="btn btn-primary" type="submit" value="CrearProfesor" name="crear" />
    ...
    <div class="modal-dialog">
        ...
        <form method="post" action="../controller/insert.php">
            ...
            <input class="btn btn-primary" type="submit" value="CrearCurso" name="crear" />
<?php if(isset($_SESSION['idCurso'])) $_SESSION['idCurso']=$_POST['id2Curso'];?>
    ...
    <div class="modal-dialog">
        ...
        <form method="post" action="../controller/insert.php">
            ...
            <input class="btn btn-primary" type="submit" value="CrearAgenda" name="crear">
...
<?php if(isset($_SESSION['id2Agenda'])) $_SESSION['id2Agenda']=$_POST['id2Agenda'];?>
    ...
    <div class="modal-dialog">
        ...
        <form method="post" action="../controller/insert.php">
            ...
            <input class="btn btn-primary" type="submit" value="CrearClase" name="crear" />
...
<?php if(isset($_SESSION['idstudent'])) $_SESSION['idstudent']=$_POST['id2student'];?>
            <input class="btn btn-primary" type="submit" value="CrearEstudian" name="crear" />
    ...
    <div class="modal-dialog">
        ...
        <form method="post" action="../controller/insert.php">
            ...
            <input class="btn btn-primary" type="submit" value="CrearEnroll" name="crear" />
